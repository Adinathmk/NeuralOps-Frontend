        ...
        {state === 'success' && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">Your account is ready. Let's get started.</p>
            </div>
        ...
        {state === 'error' && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">This link is invalid or has expired.</p>
            </div>
