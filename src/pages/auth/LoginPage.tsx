...
function initiateOAuth(provider: 'google' | 'github') {
  ...
  if (provider === 'google') {
    ...
    if (!clientId) {
      alert('Google OAuth is not configured. Add VITE_GOOGLE_CLIENT_ID to your .env file.')
      return
    }
    ...
    if (!clientId) {
      alert('GitHub OAuth is not configured. Add VITE_GITHUB_CLIENT_ID to your .env file.')
      return
    }
    const params = new URLSearchParams({
      client_id:    clientId,
    ...
    <div className="min-h-screen bg-surface-0 flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          {/* OAuth section — existing accounts only */}
          <div className="space-y-3">
            ...
            {/* Inform users OAuth signup is blocked — backend now requires email/password for new owners */}
