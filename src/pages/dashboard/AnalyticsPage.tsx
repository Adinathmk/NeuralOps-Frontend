...
const kpiCards = [
  ...
  { label: 'Avg MTTR',          value: '1.8m', delta: '-23%', positive: true,  icon: Clock,      color: 'text-primary', bg: 'bg-primary/10' },
    ...
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Last 7 days · Production</p>
        </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className={cn('text-xs mt-1 font-medium', positive ? 'text-primary' : 'text-red-400')}>
                      {delta} this week
                    </p>
                  </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-xs text-slate-500">
                  ...
                  <span className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-primary" />Resolved</span>
                </div>
              </div>
            </CardHeader>
            <CardContent>
                ...
                {weeklyData.map(({ day, incidents, resolved }) => (
                  <div key={day} className="flex-1 flex flex-col items-center gap-1.5">
                    <div className="relative w-full flex items-end gap-1" style={{ height: 140 }}>
                      ...
                      {/* Resolved bar */}
                      <div
                        className="flex-1 rounded-t-sm bg-primary/50 border border-primary/30 transition-all duration-500"
              ...
              <div className="pt-3 border-t border-slate-200 space-y-2">
                ...
                {[
                  ...
                  <div key={label} className="flex justify-between text-xs">
                    ...
                    <span className="text-primary font-mono font-medium">{mttr}</span>
                  </div>
                ))}
              </div>
            </CardContent>
                ...
                <div key={type} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs text-slate-700 truncate font-mono">{type}</span>
